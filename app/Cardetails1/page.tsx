        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <li>Corolla offers better fuel efficiency: 12-14 km/l vs. Civic 10-12 km/l.</li>
             ...
             <li>Corolla is known for its smooth, comfortable driving experience, suitable for daily commuting.</li>
            </ul>
          </div>
          <div>
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-8 mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-600">Budget-Friendly: Spread the cost of your Civic over manageable monthly payments.</p>
          </div>
          <div>
            <h3 className="text-lg font-medium text-gray-800">Trade-In Options</h3>
            <p className="text-gray-600">Maximize Value: Trade in your old vehicle for a fair market value, reducing the overall cost of your new Civic.</p>
            <hr className="my-6 border-gray-300" />
